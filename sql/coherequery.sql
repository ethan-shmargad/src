...
export async function cohereDemo(apiToken) {
    ...
    const payload = {
     ...
     truncate: 'END',
     prompt: 'How might a fusion of biotechnology and artificial intelligence reshape the blueprint for sustainable urban ecosystems?'
    };
...
begin
    ...
    coherequery('<PASTE API KEY HERE>');
end;
/
